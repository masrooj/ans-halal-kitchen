    ...
    <section id="order" className="bg-ans-gold py-20 md:py-24">
      <div className="mx-auto max-w-2xl px-6 text-center md:px-12">
        ...
        >
          ...
          <p className="mt-4 font-sans text-[17px] text-ans-emerald/70">{n.sub}</p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-3 font-sans text-xs text-ans-emerald/40">{n.disclaimer}</p>
        </form>
        ...
        <div className="mt-8 flex flex-col items-center gap-4">
          <p className="font-sans text-sm text-ans-emerald/70">{n.ready}</p>
